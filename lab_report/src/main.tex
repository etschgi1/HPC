...
\newcommand{\hrefu}[2]{\textcolor{blue}{\underline{\href{#1}{#2}}}}
...
\large
\emph{Author:}\\
Elias Wachmann (6300421) [\texttt{e.wachmann@student.tugraz.at}] \\[1.5cm]  % Add your email here
{\large \today}\\[5cm]
