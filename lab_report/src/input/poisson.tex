...
\end{figure}
\TODO{FALSCH GEMACHT - PLOT X AXIS is wrong plot iterations not gird size!!!}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        $4\times 1$ & $1.35 \cdot 10^{-1}$ & $7.11 \cdot 10^{-6}$ \\\hline
        $2\times 2$ & $1.06 \cdot 10^{-1}$ & $6.17 \cdot 10^{-6}$ \\\hline
    \end{tabular}
