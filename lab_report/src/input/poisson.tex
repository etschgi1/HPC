...
We can measure the time spent in \texttt{Exchange\_Borders} by adding a timer to the function. We run the program with a $4 \times 1$ topology, $\omega = 1.93$ and a $800 \times 800$ grid and get the following times: