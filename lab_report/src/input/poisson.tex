...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        $4\times 1$ & $200\times 200$  & $1.15 \cdot 10^{-2}$& $7.39\cdot 10^{-5}$ \\ \hline
        $4\times 1$ & $400\times 400$  & $-2.86\cdot 10^{-2}$& $3.47\cdot 10^{-4}$ \\ \hline
        $4\times 1$ & $800\times 800$  & $1.05 \cdot 10^{-1}$& $1.18\cdot 10^{-3}$ \\ \hline
        $1\times 4$ & $200\times 200$  & $6.56 \cdot 10^{-3}$& $7.94\cdot 10^{-5}$ \\ \hline
        $1\times 4$ & $400\times 400$  & $-6.52\cdot 10^{-3}$& $3.17\cdot 10^{-4}$ \\ \hline
        $1\times 4$ & $800\times 800$  & $6.09 \cdot 10^{-2}$& $1.21\cdot 10^{-3}$ \\ \hline
        $2\times 2$ & $200\times 200$  & $-9.90\cdot 10^{-4}$& $8.49\cdot 10^{-5}$ \\ \hline
        $2\times 2$ & $400\times 400$  & $5.78 \cdot 10^{-3}$& $3.01\cdot 10^{-4}$ \\ \hline
        $2\times 2$ & $800\times 800$  & $8.26 \cdot 10^{-2}$& $1.17\cdot 10^{-3}$ \\ \hline
    \end{tabular}
